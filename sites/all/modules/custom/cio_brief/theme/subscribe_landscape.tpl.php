...
<div class="subscribe_div">
  <div class="subscribe_div_title">
    <h3><span id="word-subscribe">Subscribe</span> <span
        id="word-and">and</span> <span id="word-connect">Connect</span></h3>

    <p>Gain insight on new approaches and technologies, delivered to your
      inbox!</p>
  </div>
