    ...
    <div class="buy-online-wrapper">
      <?php if ($data['is_online']): ?>
          <div class="btn_94w" style="display: block;">
              <a target="_blank" href="<?php print $data['buy_online_url'] ?>">Buy
                  Online</a>
          </div>
      <?php endif; ?>
    </div>
      ...
      <?php print $data['address'] ?>
        ...
        <div class="dist-phone-other">
          ...
          <?php if (trim($data['email']) != ''): ?>
              Email: <a
                      href="mailto:<?php print $data['email'] ?>"><?php print $data['email'] ?></a>
              <br/>
          <?php endif; ?>

          <?php if (trim($data['url']) != ''): ?>
              Web: <a href="<?php print $data['url'] ?>"
                      target="_blank"><?php print str_replace('http://', '', $data['url']) ?></a>
              <br/>
          <?php endif; ?>
