...
function() {
        ...
        var n = function(n) {
                ...
                _.each(n, function(n, t) {
                    if (!n.fuzzy && !n.add) {
                        ...
                        }).attr("src", "http://www.flukenetworks.com/sites/flukenetworks.com/files" + "/" + prod_image.toLowerCase() + ".png")
                    }
                })
            },
            e = function(n) {
    ...
    n.on("change", "#criteria input", function(n) {
        ...
        _.each(Configurator.bom.bundles, function(n) {
            ...
            _.each(n.supports, function(e) {
				...
				$("#summary-suggested").append(_.map(o, function(n) {
					if(n.id == 'TRC-CASE'){
						return $("<tr id='trc-case'><td>" + n.quantity + "</td></tr>").append('<th scope="row"><strong>' + n.id + "</strong></th>").append("<td><p>" + n.name + "</p></td>")
					}else{
						$('#trc-case').remove();
					}
				}));
    ...
    n.on("submit", "#configure", function(n) {
        ...
        if ($(this).find("input:checked").not(".provides").each(function() {
            ...
            }), !(t.length <= 0)) { //alert(JSON.stringify(t));
            ...
            if (jQuery.inArray(regCountryCookie, wifi_countries) !== -1) {
                ...
                if (t.length == 1) {
                    ...
                    if ((t[0] == "DSX8CU" && t[1] == "OLTS1" && t[2] == "OLTS2" && t[3] == "OTDR1" && t[4] == "OTDR2" && t[5] == "FI") || (t[0] == "VRM" && t[1] == "DSX8CU" && t[2] == "OLTS1" && t[3] == "OLTS2" && t[4] == "OTDR1" && t[5] == "OTDR2"))
                        wifi = 0;
                }
            }
            if (wifi == 1) {
            ...
            if (con_cat8) {
                ...
                if (t.length == 13 && t[0] == 'DV') {
                    t = _.without(t, "DV", "MISC1", "MISC2", "MISC3", "MISC4", "MISC5", "FI2");
                    t.push("FI", "VMF", "VRM");
                }
                if ((t.length == 12 && t[0] == 'DV')) {
                    t = _.without(t, "DV", "MISC1", "MISC2", "MISC3", "MISC4", "MISC5", "FI2");
                    t.push("FI", "VMF", "VRM");
                }
            ...
            o(t).then(function(n) {
                ...
                var s = function() {
												...
												var gt = {};
                    _.each(t, function(n) {
                        var gk = JSON.stringify(n),
                            t = $("<tr><td>1</td></tr>").appendTo(a),
                        ...
                        _.chain(n.modules).map(function(n) {
                            ...
                            $("<img />").appendTo(o).on("load", function(n) {
                                $(this).addClass("loaded")
												...
												var regCountryCookie = getCookie("regCountry") ? getCookie("regCountry") : "";
												if(regCountryCookie == 'US'){
													gt[g] = _.pairs(n)[0][1];
													g++;
													if(gt[0] == 'DSX-8-CFP-Q-ADD/R'){
														gt[0] = 'DSX-8-CFP-Q-ADD-R';
													}
													//PriceSpider.rebind();
