...
<div style="float:right;margin-top:5px;padding:10x 2px 0px 15px;"><span class="st_sharethis" displayText="Share" st_url="http://<?php echo url(current_path(), array('absolute' => TRUE)); ?>"></span>
<script type="text/javascript">var switchTo5x=false;</script>
<script type="text/javascript" src="http://w.sharethis.com/button/buttons.js"></script>
<script type="text/javascript">stLight.options({publisher:'396ae8ac-55d4-49d8-a774-f95d0a794c67'});</script></div>
<div style="font-size:22px;padding-bottom:10px;line-height:28px;">
