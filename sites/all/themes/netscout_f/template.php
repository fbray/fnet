...
// */
function netscout_f_preprocess_html(&$vars) {
  ...
  elseif (($occupied_column_one && $occupied_column_two) || ($occupied_column_one && $occupied_column_three) || ($occupied_column_two && $occupied_column_three)) {
...
function netscout_f_process_html(&$vars) {
}
// */
...
function netscout_f_preprocess_page(&$vars) {
  if (isset($vars['node'])) {
...
/*
function netscout_f_process_page(&$vars) {
}
// */
...
function netscout_f_preprocess_node(&$vars) {
}
function netscout_f_process_node(&$vars) {
}
// */
 ...
 */
/* -- Delete this line if you want to use these functions
function netscout_f_preprocess_comment(&$vars) {
}
function netscout_f_process_comment(&$vars) {
}
// */
 ...
 */
/* -- Delete this line if you want to use these functions
function netscout_f_preprocess_block(&$vars) {
}
function netscout_f_process_block(&$vars) {
}
// */

function netscout_f_form_element($variables) {
...
function netscout_f_fnet_button($variables) {
...
function netscout_f_theme($existing, $type, $theme, $path) {
  return array(
    'fnet_button' => array(
      'link' => NULL,
      'auto' => NULL,
 ...
 */
function netscout_f_breadcrumb($vars) {
  global $theme_key;
