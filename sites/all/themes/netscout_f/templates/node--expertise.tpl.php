...
<article id="node-<?php print $node->nid; ?>"
  ...
  $relatedcontent = $node->field_expertise_relatedcontent['und'][0]['value'];
  $mainimage = $node->field_expertise_image['und'][0]['value'];

  ?>

  <div<?php print $content_attributes; ?>>
    <?php // print render($content); ?>
    <h1 class="ExpertiseHeader"><?php print $title; ?></h1>
    <div class="expertise-content column-grid">
      <div class="col-3-4">
      ...
      <div class="col-1-4">
        <div><?php print $mainimage ?></div>
        <div style="width:230px"><?php print $relatedcontent ?></div>
      </div>
    </div>
