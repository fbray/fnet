...
<article id="node-<?php print $node->nid; ?>"
  ...
  <div<?php print $content_attributes; ?>>
    ...
    <?php }
    elseif (isset($node->field_exp_ind_banner_image['und'][0]['value'])) { ?>
      <div>
            ...
            <ul>
              ...
              <?php if ($tab1) { ?>
                <li style="width: <?php print $tabWidth ?>;"><a
                    href="#tabs-1"><?php print $node->field_exp_ind_tab_title['und'][0]['value']; ?></a>
                </li>
              <?php } ?>
              <?php if ($tab2) { ?>
                <li style="width: <?php print $tabWidth ?>;"><a
                    href="#tabs-2"><?php print $node->field_exp_ind_tab2_title['und'][0]['value']; ?></a>
                </li>
              <?php } ?>
              <?php if ($tab3) { ?>
                <li style="width: <?php print $tabWidth ?>;"><a
                    href="#tabs-3"><?php print $node->field_exp_ind_tab3_title['und'][0]['value']; ?></a>
                </li>
              <?php } ?>
              <?php if ($tab4) { ?>
                <li style="width: <?php print $tabWidth ?>;"><a
                    href="#tabs-4"><?php print $node->field_exp_ind_tab4_title['und'][0]['value']; ?></a>
                </li>
              <?php } ?>
            </ul>
          </center>
