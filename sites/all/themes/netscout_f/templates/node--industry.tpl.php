        ...
        <div class="column-grid">
              ...
              <div class="column-grid">
                <div class="col-1-3">
                  <div style="padding:1em;">
                    <img
                      src="<?php print file_create_url(fnet_common_get_field_value('family', $family, 'field_family_hub_img', 'uri')); ?>"
                ...
                <div class="col-2-3">
                  ...
                  <div class="btn_143w"><a class="show-products"
                                           href="#family-product-list-<?php print $family->nid; ?>">See
                      Products &#187;</a></div>
                </div>
              </div>
              <div class='clear_15px'>&nbsp;</div>
          ...
          <div class="col-1-3">
            <div style="margin-left: 25px;padding-top: 15px;">
              ...
              <?php if (fnet_common_safe_get($field_industry_box_desc_1, 0, 'value')) { ?>
                <hr
                  style="margin:2em 0; border:0; height:1px; background-color:#eee;"/>
              <?php } ?>
