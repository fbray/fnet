...
?>
            ...
            <div class="columns-inner clearfix">
              <div id="content-column">
                <div class="content-inner">
                  ...
                  <?php if ($member): ?>
                    <div id="extranet-header-block">
                      <div class='extranet-logo-block'>
                        <div class='block-title'>
                          <a
                            href='/extranet'><?php print t('Sales Insider'); ?></a>
                        </div>
                      ...
                      <?php if ($primary_local_tasks || $secondary_local_tasks || $action_links): ?>
                        <div id="tasks">
                          ...
                          <?php if ($primary_local_tasks): ?>
                            <ul
                              class="tabs primary clearfix"><?php print render($primary_local_tasks); ?></ul>
                          <?php endif; ?>

                          <?php if ($secondary_local_tasks): ?>
                            <ul
                              class="tabs secondary clearfix"><?php print render($secondary_local_tasks); ?></ul>
                          <?php endif; ?>

                          <?php if ($action_links = render($action_links)): ?>
                            <ul
                              class="action-links clearfix"><?php print $action_links; ?></ul>
                          <?php endif; ?>
  ...
  <div id="selectRegionBox" style="display:none;">
    ...
    <form action="" method="post" name="region">
      <div style="padding:10px 5px 5px 5px;"><strong>Select your
          country:</strong></div>
      <div class='OneLinkNoTx'>
        <select id="regionCountry" name="regionCountry"
                onchange="countryLanguage(this.value);"
                style="width:auto;font-size:12px;">
          <option value="">-- Country --</option>
        </select>
      </div>
      <div style="padding:10px 5px 5px 5px;"><strong>Select available
          language:</strong></div>
      ...
      <div style="text-align:center;">
        <div class="btn_143w" style="margin: 0px auto;"><a
            href="javascript:setRegion();"
