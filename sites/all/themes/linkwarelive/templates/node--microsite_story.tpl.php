...
hide($content['links']);
$background_color = isset($field_ms_story_bg_color[LANGUAGE_NONE][0]['value']) ? '#'.$field_ms_story_bg_color[LANGUAGE_NONE][0]['value'] : 'transparent';
$background_image = isset($field_ms_story_bg_image[LANGUAGE_NONE][0]['uri']) ? file_create_url($field_ms_story_bg_image[LANGUAGE_NONE][0]['uri']) : '';

$display_title = isset($field_display_title[LANGUAGE_NONE][0]['value']) ? $field_display_title[LANGUAGE_NONE][0]['value'] : '';
$display_title_anchor_string = str_replace(" ", "-", strtolower(trim($display_title)));

?>
<article id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> clearfix"<?php print $attributes; ?> style="background:url(<?php print $background_image; ?>) center top no-repeat <?php print $background_color; ?>;">
  <?php if ($unpublished): ?>
    <header>
      <?php if ($unpublished): ?>
