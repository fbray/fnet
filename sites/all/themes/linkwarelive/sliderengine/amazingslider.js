    ...
    $.fn.ashtml5lightbox = function (options) {
        ...
        inst.createMarkup = function () {
            var fontRef = ("https:" == document.location.protocol ?
                    "https" : "http") + "://fonts.googleapis.com/css?family=Armata";
        ...
        inst.supportKeyboard = function () {
            $(document).keyup(function (e) {
                ...
                if (inst.options.supportesckey && e.keyCode == 27)inst.finish(); else if (inst.options.supportarrowkeys)if (e.keyCode == 39)inst.gotoSlide(-1); else if (e.keyCode ==
                    37)inst.gotoSlide(-2)
            })
        };
    ...
    $.fn.amazingslider = function (options) {
        ...
        AmazingSlider.prototype = {
            initData: function (onSuccess) {
                ...
                $(".amazingslider-slides", this.container).find("li").each(function () {
                    ...
                    if (img.length > 0) {
                        ...
                        if ($("button", $(this)).length > 0)if ($("button", $(this)).parent().is("a"))button =
                            $("button", $(this)).parent().clone().wrapAll("<div/>").parent().html(); else button = $("button", $(this)).clone().wrapAll("<div/>").parent().html();
                        var video = [];
                        ...
                        var elem =
                            new Array(instance.elemArray.length, src, title, description, link, target, video, "", lightbox, lightboxwidth, lightboxheight, dataWebm, dataOgg, texteffect, duration, button);
                ...
                if (!isNaN(paramValue) && paramValue >= 1 && paramValue <= instance.elemArray.length)firstSlide = paramValue -
                    1;
                ...
                $(".amazingslider-ribbon-" + this.id, this.container).html("<img src='" + this.options.skinsfolder + this.options.ribbonimage +
                    "' style='border:none;' />")
            }, createWm: function () {
                ...
                if (this.options.watermarklink) {
                    ...
                    if (this.options.watermarktitle)html +=
                ...
                if (this.options.watermarkstyle == "text" && this.options.watermarktext.length >
                    0)stylecode += this.options.watermarktextcss;
                ...
                if (!this.options.nativehtml5controls)$("video", $container).asHTML5VideoControls(this.options.skinsfolder,
            ...
            resizeFullscreenImage: function ($imgElem) {
                ...
                if (this.options.navstyle == "bullets") {
                    ...
                    $.fn["bulletSelected" + this.id] = function () {
                        ...
                        if (instance.options.navdirection == "horizontal") {
                            ...
                            if (instance.options.navposition == "top" || instance.options.navposition == "topleft" || instance.options.navposition == "topright")t = pos.top + instance.options.navheight; else t =
                            ...
                            if (instance.options.navposition ==
                                "left")l = pos.left + instance.options.navwidth; else l = pos.left - instance.options.navfeaturedarrowimagewidth;
                            if (instance.options.navshowfeaturedarrow) {
                                var $featuredarrow = $(".amazingslider-nav-featuredarrow-" + instance.id, instance.container);
                ...
                $(imgLoader).load(function () {
                    ...
                    if (Math.abs(instance.curImageMarginLeft) > 0)imgCurCodes +=
                        "max-width:" + instance.curImageMaxWidth + "%;width:" + instance.curImageMaxWidth + "%;height:100%;left:0%;top:0%;margin-left:" + instance.curImageMarginLeft + "%"; else imgCurCodes += "max-width:" + instance.curImageMaxWidth + "%;width:" + instance.curImageMaxWidth + "%;height:auto;left:0%;top:0%;margin-top:" + instance.curImageMarginTop + "%;";
                            ...
                            function () {
                                if (instance.elemArray[instance.curElem][ELEM_LIGHTBOX]) {
                                    ...
                                    $(window).trigger("amazingslider.linkclicked",
                                        [instance.options.sliderid, instance.elemArray[instance.curElem][ELEM_ID], instance.elemArray[instance.curElem][ELEM_SRC], instance.elemArray[instance.curElem][ELEM_TITLE], instance.elemArray[instance.curElem][ELEM_LINK]]);
        ...
        this.each(function () {
            ...
            if ($(this).data("textformat") && typeof AMAZINGSLIDER_TEXT_EFFECT_FORMATS !== "undefined")if ($(this).data("textformat")in AMAZINGSLIDER_TEXT_EFFECT_FORMATS)this.options =
                $.extend({}, AMAZINGSLIDER_TEXT_EFFECT_FORMATS[$(this).data("textformat")], this.options);
            ...
            var effects =
                ["slice", "blocks", "threedtiles", "tiles", "slide", "elastic", "crossfade", "kenburns", "threedhorizontal", "threedhorizontalwithzoom", "fade", "shuffle", "threed", "threedwithzoom", "blinds", "threedflip", "threedflipwithzoom", "flip", "flipwithzoom"];
...
(function ($) {
    ...
    $.fn.kenburnsTransition = function (id, $prev, $next, options, callback, transitionStartCallback) {
        ...
        if (ASPlatforms.isIE6789()) {
            ...
            var opacity_frames = 60 * options.fadeduration /
                1E3;
            ...
            if (effect == "zoomout") {
                    ...
                    switch (direction) {
                        ...
                        case 1:
                            context.drawImage(image,
                                0, 0, w, h, 0, h - scale * h, scale * w, scale * h);
                            break;
                        case 2:
                ...
                (function asDrawKenBurnsZoomIn() {
                    ...
                    switch (direction) {
                        case 0:
                            context.drawImage(image, 0, 0, w, h, w - scale * w, h - scale *
                                h, scale * w, scale * h);
                            break;
                        case 1:
    ...
    $.fn.threedTransition = function (id, $prev, $next, options, callback, transitionStartCallback) {
        ...
        cubes.each(function () {
            ...
            setTimeout(function () {
                if (scaleDuration >
                    0)cube.css(ASPlatforms.applyBrowserStyles({
                    "transition-timing-function": options.easing,
    ...
    $.fn.threedHorizontalTransition = function (id, $prev, $next, options, callback, transitionStartCallback) {
        ...
        for (i = 0; i < options.slicecount; i++) {
            ...
            $curImgSlice.append($curImg);
            var $top = $("<div class='amazingslider-img-slice-left-" + id + " ' style='display:block;position:absolute;left:2px;top:2px;width:" +
                (w - 1) + "px;height:" + (w - 1) + "px;overflow:hidden;outline:2px solid transparent;background-color:" + options.bgcolor + ";'></div>");
            ...
            var $imgCube = $("<div class='amazingslider-img-cube-" + id + " ' style='display:block;position:absolute;left:0%;top:" + i * sliceH + "px;width:100%;height:" +
                sliceH + "px;'></div>");
            $imgCube.append($top);
        ...
        cubes.each(function () {
            ...
            setTimeout(function () {
                cube.css(ASPlatforms.applyBrowserStyles({
                    "transition-timing-function": options.easing,
                    "transition-duration": duration + "ms",
                    "transform": "scale(" + options.scale + ") translateZ(-" + options.depth / 2 + "px" + ") rotateY(" + (options.direction ? "-180" : "180") + "deg)"
                }));
    ...
    $.fn.tilesTransition = function (id, $prev, $next, options, callback, transitionStartCallback) {
        ...
        var interval = totalDuration / 2 / (options.rowcount *
            options.columncount);
        var duration = totalDuration / 2;
        $prev.hide();
        index = 0;
