...
<div class="mkto-content-main" class="content clear-block">
  <div id="mkt-prod-banner">
  	<?php if(!empty($node->field_fnet_mkto_banner_img[LANGUAGE_NONE])): 
  ...
  <div id="mkto-content">
    <div id="mkt-prod-details">
      <div id="mkt-prod-title" class="t1-title">
		...
		<?php if(!empty($node->field_fnet_mkto_prod_img_left[LANGUAGE_NONE])): ?>
      <div id="mkt-prod-img-left">
        <?php
          print render($content['field_fnet_mkto_prod_img_left']);       
				?> 
      </div>
		<?php elseif(!empty($node->field_fnet_mkto_prod_img_right[LANGUAGE_NONE])): ?>
